...
from .const import (
    ...
    TYPE_VALVE,
    DEVICE_NEST_CAMERA,
    DEVICE_NEST_CAMERA_SENSOR,
    DEVICE_NEST_HUMIDIFIER,
    DEVICE_NEST_PROTECT,
    DEVICE_NEST_TEMPERATURE_SENSOR,
    DEVICE_NEST_THERMOSTAT,
    DEVICE_SMARTTHINGS_BUTTON,
    DEVICE_SMARTTHINGS_MOTION_SENSOR,
    DEVICE_SONY_BRAVIA,
)
from .util import (
    convert_to_float,
...
CUSTOM_DEVICES = {
    DEVICE_NEST_CAMERA: "NestCamera",
    DEVICE_NEST_CAMERA_SENSOR: "NestCameraSensor",
    DEVICE_NEST_HUMIDIFIER: "NestHumidifier",
    DEVICE_NEST_PROTECT: "NestProtect",
    DEVICE_NEST_TEMPERATURE_SENSOR: "NestTemperatureSensor",
    DEVICE_NEST_THERMOSTAT: "NestThermostat",
    DEVICE_SMARTTHINGS_BUTTON: "SmartThingsButton",
    DEVICE_SMARTTHINGS_MOTION_SENSOR: "SmartThingsMotionSensor",
...
def get_accessory(hass, driver, state, aid, config):
    ...
    elif domain in ("automation", "input_boolean", "remote", "scene", "script"):
        a_type = "Switch"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if ATTR_MANUFACTURER in self.config:
            ...
            manufacturer = f"{MANUFACTURER}".title()
